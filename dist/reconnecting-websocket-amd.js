define(['react-native-background-timer'], function (RNTimer) { 'use strict';

    RNTimer = RNTimer && RNTimer.hasOwnProperty('default') ? RNTimer['default'] : RNTimer;
     ...
     * License MIT
     */
    const _setTimeout = RNTimer ? (callback, time) => RNTimer.setTimeout(callback, time) : setTimeout;
    const _clearTimeout = RNTimer ? (time) => RNTimer.clearTimeout(time) : clearTimeout;
    ...
    class ReconnectingWebSocket {
        ...
        _clearTimeouts() {
            _clearTimeout(this._connectTimeout);
            _clearTimeout(this._uptimeTimeout);
        }
    }
